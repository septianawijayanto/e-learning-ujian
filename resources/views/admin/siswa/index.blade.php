                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group {{ $errors->has('nisn') ? 'has-error' : '' }}">
                                    ...
                                    <input name="nisn" type="text" class="form-control" id="inputnisn"
                                        placeholder="Input No Induk" value="{{ old('nisn') }}">
                                    @if ($errors->has('nisn'))
                                        <span class="right badge badge-danger"
